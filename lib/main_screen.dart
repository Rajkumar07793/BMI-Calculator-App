...
const activeColor = Color.fromARGB(255, 17, 53, 53);
          ...
          Expanded(
            child: ContainerBox(
              ...
              childwidget: Column(
                ...
                children: <Widget>[
                  Text(
                    'Developed with ❤ by Raj kumar Patel',
                    style: textStyle1,
                  ),
                  SizedBox(
                    height: 10.0,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      FloatingActionButton(
                        elevation: 0,
                        onPressed: () {
                          launch('https://www.instagram.com/rajkumar07793/');
                        },
                      ...
                      FloatingActionButton(
                        elevation: 0,
                        onPressed: () {
                          launch('https://www.facebook.com/Rajkumar07793');
                        },
                        backgroundColor: inActiveColor,
                      ...
                      FloatingActionButton(
                        elevation: 0,
                        onPressed: () {
                          launch('https://twitter.com/Rajkumar07793');
                        },
                        backgroundColor: inActiveColor,
                        child:
                      ...
                      FloatingActionButton(
                        ...
                        onPressed: () {
                          launch(
                              'https://www.linkedin.com/in/raj-kumar-patel-696606b1/');
                        },
                        backgroundColor: inActiveColor,
